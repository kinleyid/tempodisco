...
| `additive-utility` ([Killeen, 2009](https://doi.org/10.1037/a0016414)) | $f(t; k, s, a) = \left( 1 - \frac{k}{V_D^a}t^s\right)^\frac{1}{a}$ | Here, $V_D$ is the value of the delayed reward. For $t > \left(V_D^a / k\right)^{1/s}$, $f(t; k, s, a) = 0$. |
