...
| `hyperbolic.2` | ([Mazur, 1987](https://doi.org/10.4324/9781315825502)):<br><br>$\frac{1}{1 + kt}$ | $\beta_1\left( \sigma^{-1}\left[\frac{v_I}{v_D}\right] + \log t \right) + \beta_2$ | $k = e^\frac{\beta_2}{\beta_1}$ |
...
| `exponential.2` | Exponential ([Samuelson, 1937](https://doi.org/10.2307/2967612)):<br><br>$e^{-kt}$ | $\beta_1\left( G^{-1}\left[\frac{v_I}{v_D}\right] + \log t \right) + \beta_2$ | $k = e^\frac{\beta_2}{\beta_1}$ |
...
| `arithmetic.1` | Arithmetic ([Doyle & Chen, 2010](https://dx.doi.org/10.2139/ssrn.1609594)):<br><br>$1 - k\frac{t}{v_D}$ | $\beta_1\left(v_I - v_D\right) + \beta_2 t$ | $k = \frac{\beta_2}{\beta_1}$ |
| `arithmetic.2` | Arithmetic ([Doyle & Chen, 2010](https://dx.doi.org/10.2139/ssrn.1609594)):<br><br>$1 - k\frac{t}{v_D}$ | $\beta_1\left(\log t - \log\left(v_D - v_I\right)\right) + \beta_2$ | $k = e^\frac{\beta_2}{\beta_1}$ |
...
| `nonlinear-time-exponential` | Nonlinear-time exponential ([Ebert & Prelec, 2007](https://doi.org/10.1287/mnsc.1060.0671)):<br><br>$e^{-kt^s}$ | $\beta_1 G^{-1}\left[\frac{v_I}{v_D}\right] + \beta_2\log t + \beta_3$ | $k = e^\frac{\beta_3}{\beta_1}$, $s = \frac{\beta_2}{\beta_1}$ |
