...
| `arithmetic` | Arithmetic ([Doyle & Chen, 2010](https://dx.doi.org/10.2139/ssrn.1609594)):<br><br>$1 - k\frac{t}{v_D}$ | $\beta_1\left(v_I - v_D\right) + \beta_2 t$ | $k = \frac{\beta_2}{\beta_1}$ |
