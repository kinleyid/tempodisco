...
mod1 <- td_bcm(td_bc_single_ptpt, discount_function = 'scaled-exponential')
mod2 <- td_bcm(td_bc_single_ptpt, discount_function = 'nonlinear-time-hyperbolic')
...
This latter method has the advantage of being well-defined for the "model-free" discount function.
