...
To fit an even wider range of discount functions, we can fit a nonlinear regression model by calling `td_bcnm`. A full list of the available discount functions can be found in the documentation for `td_bcnm`.
