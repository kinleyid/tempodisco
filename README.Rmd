...
This implementation follows the model described in [Peters & D'Esposito (2020)](https://doi.org/10.1371/journal.pcbi.1007615); the drift rate is based on the difference in subjective value between the immediate and delayed rewards, where the subjective value of 
